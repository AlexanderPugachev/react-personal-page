  ...
  render () {
    ...
    return (
      <div className="project">
          ...
          <div className="project--descr_grid">
            ...
            <div className="grid_right">
              ...
              <form className="project--grid_list project--view">
                <Button name="view_button" id={'_prj_' + PrjId} value={0} onClick={this.handleClick}
                        text='HD'/>
                <Button name="view_button" id={'_prj_' + PrjId} value={1} onClick={this.handleClick}
                        text='Full HD'/>
                <Button name="view_button" id={'_prj_' + PrjId} value={2} onClick={this.handleClick}
                        text='mobile'/>
              </form>
            </div>
          </div>
        ...
        <div id='project--back' className="project--background"/>
      </div>
    );
  }
